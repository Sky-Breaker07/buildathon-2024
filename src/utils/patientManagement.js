...
const getHospitalRecord = (hospitalId) => {
  return apiClient.post('/api/v1/patients/hospital-records', { hospital_id: hospitalId });
};
...
const assignPatientToHCP = (hospitalId, staffId) => {
  return apiClient.post('/api/v1/patients/assign-patient', { hospital_id: hospitalId, staff_id: staffId });
};
...
const updatePatientInfo = (updateData) => {
  return apiClient.put('/api/v1/patients/update-patient-info', updateData);
};
