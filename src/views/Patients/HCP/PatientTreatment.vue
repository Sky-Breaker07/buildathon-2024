	...
	<div class="min-h-screen px-4 sm:px-6 lg:px-8">
		...
		<div class="max-w-7xl mx-auto">
			...
			<div v-if="activeTab === 'new' && patientData">
				...
				>
					<p class="text-lg text-gray-600">
						No treatment templates are available for your
						profession.
					</p>
				...
				>
					...
					<div class="p-6">
						...
						>
							<p class="text-lg text-gray-600">
								No treatment templates available for your
								profession.
							</p>
							<p class="text-md text-gray-500 mt-2">
				...
				>
					...
					<div class="p-6">
						<form
							@submit.prevent="submitTreatment"
							class="space-y-8"
						>
							<div
								v-for="(
							...
							>
								...
								>
									...
									<component
										...
										:id="`${sectionName}_${fieldKey}`"
										:value="
											treatmentData[sectionName][fieldKey]
										"
										@input="
											updateTreatmentData(
												sectionName,
...
<script setup>
	...
	const fetchTreatmentTemplates = async () => {
		try {
			...
			if (error.response && error.response.status === 404) {
				...
				toast.error(
					'Failed to fetch treatment templates. Please try again.'
				);
			}
		} finally {
			loadingModal.value.hide();
	...
	const resetForm = () => {
		if (selectedTemplate.value) {
			treatmentData.value = Object.keys(
