	...
	<div class="min-h-screen px-4 sm:px-6 lg:px-8">
		...
		<div class="max-w-7xl mx-auto">
			...
			<div v-if="activeTab === 'new' && patientData">
				...
				>
					<p class="text-lg text-gray-600">
						No assessment templates are available for your
						profession.
					</p>
					<p class="text-md text-gray-500 mt-2">
						Please contact an administrator to create templates
						before adding new assessments.
					</p>
				</div>
				<!-- Template Selection -->
				<div
				...
				>
					...
					<div class="p-6">
						...
						>
							<p class="text-lg text-gray-600">
								No assessment templates available for your
								profession.
							</p>
							<p class="text-md text-gray-500 mt-2">
...
<script setup>
	...
	const fetchAssessmentTemplates = async () => {
		try {
			...
			if (error.response && error.response.status === 404) {
				...
				toast.error(
					'Failed to fetch assessment templates. Please try again.'
				);
			}
		} finally {
			loadingModal.value.hide();
	...
	const resetForm = () => {
		if (selectedTemplate.value) {
			assessmentData.value = Object.keys(
