<template>
	...
	>
		...
		>
			...
			<ul class="list-disc list-inside text-blue-600 space-y-2">
				...
				<li>Add sections to organize your referral.</li>
				<li>
	...
	<teleport to="body">
		<div
			...
			class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 overflow-y-auto font-poppins"
		>
...
<script setup>
	...
	import { createReferralTemplate } from '@/utils/referralTemplate';
	...
	const referralTemplateStore = useReferralTemplateStore();
	...
	const saveTemplate = async () => {
		try {
			...
			const response = await createReferralTemplate(templateData);
			referralTemplateStore.addTemplate(response.data);
