		...
		<div class="space-y-6">
			<div class="relative">
				<input
					...
					class="w-full p-3 border-2 border-indigo-300 rounded-lg outline-none transition-all duration-300 pl-10"
			...
			<div class="relative">
				<textarea
					v-model="description"
					class="w-full min-h-[8rem] p-3 border-2 resize-none border-indigo-300 rounded-lg transition-all outline-none duration-300 pl-10"
